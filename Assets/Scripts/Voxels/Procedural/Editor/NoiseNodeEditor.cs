...
namespace Tuntenfisch.Editor.Voxels
{
    ...
    public class NoiseNodeEditor : UnityEditor.Editor
    {
        ...
        private bool m_noiseParametersFoldout = true;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!m_isInitialized)
            {
                EditorGUILayout.HelpBox("Compute resources could not be initialized. Check console for errors.", MessageType.Error);
